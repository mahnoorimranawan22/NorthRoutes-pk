...
export default function Booking() {
  ...
  return (
    <>
      <PageMeta title="Checkout - Passu Peaks Travels" description="Complete your booking" />
      <div className="min-h-screen bg-gray-50">
        {/* Header */}
        <div className="bg-gradient-to-r from-green-700 via-green-600 to-orange-500 text-white py-8 px-4">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl md:text-3xl font-bold">Checkout</h1>
            <p className="text-orange-100 mt-1">Complete your Passu Peaks Travels booking</p>
          </div>
        </div>
                          ...
                          <div className="space-y-3">
                            <div className="bg-gray-50 rounded-lg p-4 text-sm">
                              ...
                              <div className="space-y-1 text-gray-600">
                                ...
                                <p><span className="font-medium">Account Title:</span> Passu Peaks Travels (Pvt) Ltd</p>
                ...
                <div className="max-w-lg mx-auto text-center">
                  <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: "spring", duration: 0.5 }}>
                    <div className="bg-white rounded-2xl border p-8 shadow-lg">
                      ...
                      <p className="text-gray-500 mb-6">Your Passu Peaks Travels trip has been booked successfully</p>
