...
const destinations = [
  {
    name: "Naran",
    slug: "naran",
    description: "A scenic valley in Kaghan known for lush meadows, pine forests, and crystal-clear rivers.",
  ...
  },
  {
    name: "Batakundi",
    slug: "batakundi",
    description: "A peaceful village near Naran with breathtaking views of the Kaghan Valley and surrounding peaks.",
  ...
  },
  {
    name: "Babusar Top",
    slug: "babusar-top",
    description: "A high mountain pass at 4,173m offering panoramic views of Nanga Parbat and the Kaghan Valley.",
  ...
  },
  {
    name: "Hunza",
    slug: "hunza",
    description: "A mesmerizing valley in Gilgit-Baltistan with ancient forts, pristine lakes, and towering peaks.",
